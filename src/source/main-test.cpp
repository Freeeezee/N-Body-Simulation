...
#include "../include/simulations/SequentialSimulationAoS.hpp"
...
int main(int argc, char** argv) {
    ...
    for (const int count : bodyCounts) {
        ...
        //suite.registerSimulation<SequentialSimulationAoS>("SequentialAoS", false);
        //suite.registerSoA2Simulation<SequentialSimulationSoA2>("SequentialSoA2_Baseline", true);
        suite.registerSimulation<OpenMpSimulationAoS>("OpenMpSimulationAoS", false);
        ...
        suite.registerSoA2Simulation<OpenMpSimulationSoA2SplitLoop>("OpenMpSimulationSoA2SplitLoop", false);
